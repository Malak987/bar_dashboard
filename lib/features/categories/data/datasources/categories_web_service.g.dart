...
class _CategoriesWebService implements CategoriesWebService {
  _CategoriesWebService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<ApiResponse<PaginatedCategoriesModel>> getAllCategories({
    ...
    final _options = _setStreamType<ApiResponse<PaginatedCategoriesModel>>(
    ...
    late ApiResponse<PaginatedCategoriesModel> _value;
    try {
      _value = ApiResponse<PaginatedCategoriesModel>.fromJson(
        _result.data!,
        (json) =>
            PaginatedCategoriesModel.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
  ...
  Future<ApiResponse<CategoryModel>> getCategoryById(String id) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponse<CategoryModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponse<CategoryModel> _value;
    try {
      _value = ApiResponse<CategoryModel>.fromJson(
        _result.data!,
  ...
  @override
  Future<ApiResponse<dynamic>> archiveCategory(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponse<dynamic>>(
      Options(method: 'DELETE', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/Categories/ArchiveCategory/${id}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  @override
  Future<ApiResponse<dynamic>> unArchiveCategory(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponse<dynamic>>(
      Options(method: 'PATCH', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/Categories/UnArchiveCategory/${id}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
