...
class _OrdersWebService implements OrdersWebService {
  _OrdersWebService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<ApiResponse<PaginatedOrdersModel>> getMyOrders({
    ...
    final _options = _setStreamType<ApiResponse<PaginatedOrdersModel>>(
    ...
    late ApiResponse<PaginatedOrdersModel> _value;
    try {
      _value = ApiResponse<PaginatedOrdersModel>.fromJson(
        _result.data!,
  ...
  @override
  Future<ApiResponse<dynamic>> placeOrder(PlaceOrderRequestModel body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<ApiResponse<dynamic>> cancelOrder(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
