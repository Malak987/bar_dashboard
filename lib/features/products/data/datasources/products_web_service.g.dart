...
part of 'products_web_service.dart';
...
class _ProductsWebService implements ProductsWebService {
  _ProductsWebService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<ApiResponse<PaginatedProductsModel>> getAllProducts({
    ...
    final _options = _setStreamType<ApiResponse<PaginatedProductsModel>>(
    ...
    late ApiResponse<PaginatedProductsModel> _value;
    try {
      _value = ApiResponse<PaginatedProductsModel>.fromJson(
        _result.data!,
        (json) => PaginatedProductsModel.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
  ...
  Future<ApiResponse<dynamic>> addProduct({
    ...
    required String isBestSeller,
    required String isCustomizable,
    ...
    _data.fields.add(MapEntry('IsFeatured', isFeatured));
    _data.fields.add(MapEntry('IsBestSeller', isBestSeller));
    _data.fields.add(MapEntry('IsCustomizable', isCustomizable));
  ...
  @override
  Future<ApiResponse<dynamic>> archiveProduct(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<ApiResponse<dynamic>> unArchiveProduct(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponse<dynamic>>(
      Options(method: 'PATCH', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/Products/UnArchiveProduct/${id}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<ApiResponse<dynamic>> assignFlavorsToProduct(
    AssignFlavorsRequestModel body,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
